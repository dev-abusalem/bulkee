...
const Model = ({ showModel, setShowModel, title, children }) => {
  return (
    <section className=" relative">
      ...
      >
        <div className=" p-4 min-w-[400px] max-h-full   ">
          {/* <!-- Modal content --> */}
          <div className="absolute m-10 md:m-0 min-w-[400px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow dark:bg-gray-700">
            {/* <!-- Modal header --> */}
